...
class MCVSSearcher:
    ...
    def _quick_rollout(self, game):
        ...
        return float(current.check_winner())
    ...
    def search_with_time_budget(self, game, time_budget: float):
        ...
        while time.time() - start_time < time_budget:
            ...
            if current_game.is_terminal():
                ...
                if self.use_nets:
                    # Your original net code here
                    pass  # Keep your existing net evaluation
                else:
                ...
                for m in legal_moves:
                    ...
                    child_prior = prior_dict.get(m, 1.0 / len(legal_moves)) if not self.use_nets else ...  # your prior
                    child = self.Node(prior=child_prior, zone=child_Z)
