...
class BreakthroughTournament:
    def __init__(self, num_games=200, time_per_move=1.0, max_moves_per_game=300, device='cpu', output_file="breakthrough_tournament_200_results.txt"):
    ...
    def play_game(self, agent_white, agent_black, game_idx):
        ...
        while not game.is_terminal() and moves < self.max_moves_per_game:
            moves += 1
            is_white = (moves % 2 == 1)  # PLAYER1 (first mover) on odd moves
            ...
            # Final fallback: uniform random over legal moves
...
if __name__ == "__main__":
    ...
    tournament = BreakthroughTournament(num_games=200, time_per_move=1.5, max_moves_per_game=150, device=DEVICE)
